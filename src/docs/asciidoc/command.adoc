...
In the link:../../main/java/com/trustedshops/examples/petterns/command/commands/AbstractCommand.java[AbstractCommand] class you can see the chain execution code:
...
For the undo command we have to call the undo function of all commands in *reverse* order. Therefor we have to stat with the last Command and then call the ancestor in the link:../../main/java/com/trustedshops/examples/petterns/command/commands/AbstractCommand.java[AbstractCommand] class.
...
To find the last element of a command chain we use the special helper Command link:../../main/java/com/trustedshops/examples/petterns/command/commands/CommandChain.java[CommandChain] class.
